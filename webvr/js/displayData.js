...
function makeBalls(data){
  ...
  text.traverse( function ( object ) { object.visible = false; } );

  balls.traverse( function ( object ) { object.visible = false; } );
...
function makePlanes(data){
  ...
  for (var i = 1; i < data.length; i++) {
    ...
    var planeMat = new THREE.MeshBasicMaterial({side:THREE.DoubleSide,wireframe:false,transparent: true});
