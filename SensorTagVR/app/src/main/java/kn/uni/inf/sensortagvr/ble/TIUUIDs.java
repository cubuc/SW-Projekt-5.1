...
public class TIUUIDs {
    ...
    final static String UUID_ACC_CONF = "f000aa12-0451-4000-b000-000000000000"; // 0: disable, 1: enable
    final static String UUID_HUM_SERV = "f000aa20-0451-4000-b000-000000000000";
    final static String UUID_HUM_DATA = "f000aa21-0451-4000-b000-000000000000";
    final static String UUID_HUM_CONF = "f000aa22-0451-4000-b000-000000000000"; // 0: disable, 1: enable
    final static String UUID_MAG_SERV = "f000aa30-0451-4000-b000-000000000000";
    final static String UUID_MAG_DATA = "f000aa31-0451-4000-b000-000000000000";
    final static String UUID_MAG_CONF = "f000aa32-0451-4000-b000-000000000000"; // 0: disable, 1: enable
    final static String UUID_OPT_SERV = "f000aa70-0451-4000-b000-000000000000";
    final static String UUID_OPT_DATA = "f000aa71-0451-4000-b000-000000000000";
    final static String UUID_OPT_CONF = "f000aa72-0451-4000-b000-000000000000"; // 0: disable, 1: enable
    final static String UUID_BAR_SERV = "f000aa40-0451-4000-b000-000000000000";
    final static String UUID_BAR_DATA = "f000aa41-0451-4000-b000-000000000000";
    final static String UUID_BAR_CONF = "f000aa42-0451-4000-b000-000000000000"; // 0: disable, 1: enable
    final static String UUID_GYR_SERV = "f000aa50-0451-4000-b000-000000000000";
    final static String UUID_GYR_DATA = "f000aa51-0451-4000-b000-000000000000";
    final static String UUID_GYR_CONF = "f000aa52-0451-4000-b000-000000000000"; // 0: disable, bit 0: enable x, bit 1: enable y, bit 2: enable z
    private final static String
            UUID_DEVINFO_SERV = "0000180a-0000-1000-8000-00805f9b34fb";
    private final static String UUID_DEVINFO_FWREV = "00002A26-0000-1000-8000-00805f9b34fb";
    private final static String UUID_IRT_PERI = "f000aa03-0451-4000-b000-000000000000"; // Period in tens of milliseconds
    private final static String UUID_ACC_PERI = "f000aa13-0451-4000-b000-000000000000"; // Period in tens of milliseconds
    private final static String UUID_HUM_PERI = "f000aa23-0451-4000-b000-000000000000"; // Period in tens of milliseconds
    private final static String UUID_MAG_PERI = "f000aa33-0451-4000-b000-000000000000"; // Period in tens of milliseconds
    private final static String UUID_OPT_PERI = "f000aa73-0451-4000-b000-000000000000"; // Period in tens of milliseconds
    private final static String UUID_BAR_CALI = "f000aa43-0451-4000-b000-000000000000"; // Calibration characteristic
    private final static String UUID_BAR_PERI = "f000aa44-0451-4000-b000-000000000000"; // Period in tens of milliseconds
    private final static String UUID_GYR_PERI = "f000aa53-0451-4000-b000-000000000000"; // Period in tens of milliseconds

    private final static String UUID_MOV_SERV = "f000aa80-0451-4000-b000-000000000000";
    private final static String UUID_MOV_DATA = "f000aa81-0451-4000-b000-000000000000";
    private final static String UUID_MOV_CONF = "f000aa82-0451-4000-b000-000000000000"; // 0: disable, bit 0: enable x, bit 1: enable y, bit 2: enable z
    private final static String UUID_MOV_PERI = "f000aa83-0451-4000-b000-000000000000"; // Period in tens of milliseconds

    private final static String UUID_TST_SERV = "f000aa64-0451-4000-b000-000000000000";
    private final static String UUID_TST_DATA = "f000aa65-0451-4000-b000-000000000000"; // Test result

    private final static String UUID_KEY_SERV = "0000ffe0-0000-1000-8000-00805f9b34fb";
    private final static String UUID_KEY_DATA = "0000ffe1-0000-1000-8000-00805f9b34fb";
    private static final HashSet<UUID> config = new HashSet<>();
    private static final HashSet<UUID> data = new HashSet<>();
...
// --Commented out by Inspection START (04.07.2017 16:08):
//    /**
...
//    }
// --Commented out by Inspection STOP (04.07.2017 16:08)
}
