...
public class TIUUIDs {
    ...
    public final static UUID
            ...
            UUID_CCC = fromString("00002902-0000-1000-8000-00805f9b34fb"),
    ...
    public static final UUID[] UUID_DATA = {UUID_IRT_DATA, UUID_ACC_DATA, UUID_HUM_DATA, UUID_MAG_DATA, UUID_OPT_DATA, UUID_BAR_DATA, UUID_GYR_DATA, UUID_MOV_DATA};
}
