...
\framebox{\includegraphics[scale=0.4]{pics/GUI-entwurf/01-GUI-startup.png}}
\end{minipage}
...
\end{minipage} \hfill
\begin{minipage}{0.5\textwidth}
\framebox{\includegraphics[scale=0.4]{pics/GUI-entwurf/02-GUI-main.png}}
\end{minipage}
...
\end{minipage} \hfill
\begin{minipage}{0.5\textwidth}
\framebox{\includegraphics[scale=0.4]{pics/GUI-entwurf/03-GUI-record.png}}
\end{minipage}
...
\end{minipage} \hfill
\begin{minipage}{0.5\textwidth}
\framebox{\includegraphics[scale=0.4]{pics/GUI-entwurf/04-GUI-VR.png}}
\end{minipage}
...
\end{minipage} \hfill
\begin{minipage}{0.5\textwidth}
\framebox{\includegraphics[scale=0.4]{pics/GUI-entwurf/05-GUI-settings.png}}
\end{minipage}
